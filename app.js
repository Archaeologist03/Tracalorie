...
//             // loop thru cals and add each to total
//             data.items.forEach(item => {
//                 total += item.calories;
//             });
...
//         document.querySelector(UISelectors.itemList).addEventListener("click", itemeEditClick);
